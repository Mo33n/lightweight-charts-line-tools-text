import { LineToolPaneView, TextRenderer, CompositeRenderer, deepCopy, BoxHorizontalAlignment, BoxVerticalAlignment, AnchorPoint, PaneCursorType, TextAlignment, BaseLineTool, merge, getToolCullingState, OffScreenState } from 'lightweight-charts-line-tools-core';
 ...
 */
class LineToolTextPaneView extends LineToolPaneView {
    /**
 ...
 */
class LineToolText extends BaseLineTool {
    /**
    ...
    constructor(coreApi, chart, series, horzScaleBehavior, options = {}, points = [], priceAxisLabelStackingManager) {
        ...
        const finalOptions = deepCopy(TextToolDefaultOptions);
...
export { LineToolText, registerTextPlugin as default, registerTextPlugin };
//# sourceMappingURL=lightweight-charts-line-tools-text.js.map
